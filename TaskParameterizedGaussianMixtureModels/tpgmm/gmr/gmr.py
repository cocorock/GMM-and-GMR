...
class GaussianMixtureRegression(RegressionModel):
    ...
    def _equation_5(self, translation: ndarray, rotation_matrix: ndarray):
        ...
        print(f"eq5 Sorted means shape: {sorted_means.shape}")  # Should be (num_frames, num_features, num_components)
        ...
        print(f"eq5 Sorted covariances shape: {sorted_covariances.shape}")  # Should be (num_frames, num_features, num_features, num_components)
    ...
    def fit(self, translation: ndarray, rotation_matrix: ndarray) -> None:
        ...
        print(f"fit Rotation matrix shape: {rotation_matrix.shape}")  # Should be (num_frames, num_features, num_features)
